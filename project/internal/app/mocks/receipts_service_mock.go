...
// Source: tickets/internal/app (interfaces: ReceiptsService)
...
// VoidReceipt mocks base method.
func (m *MockReceiptsService) VoidReceipt(arg0 context.Context, arg1, arg2 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "VoidReceipt", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}

// VoidReceipt indicates an expected call of VoidReceipt.
func (mr *MockReceiptsServiceMockRecorder) VoidReceipt(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "VoidReceipt", reflect.TypeOf((*MockReceiptsService)(nil).VoidReceipt), arg0, arg1, arg2)
}
